    ...
    public class FerramentaController : BaseApiController
    {
        ...
        public IActionResult Get([FromQuery] string codigo, string nome, int numeroPagina, int tamanhoPagina)
        {
            ...
            catch (Exception ex)
            {
                ...
                return BadRequest($"Ocorreu um erro ao buscar as ferramentas: {msgErro}");
            }
        }
        ...
        /// </summary>
        /// <param name="dto">Informações da ferramenta: código, descrição, quantidade, valor de compra, número patrimonial, localização.</param>
        /// <returns></returns>
        [HttpPost]
        ...
        /// </summary>
        /// <param name="dto">Informações da ferramenta: id, código, descrição, quantidade, valor de compra, número patrimonial, localização.</param>
        /// <returns></returns>
        [HttpPut]
        //[AuthorizeRoles(RoleEnum.Administrador)]
        ...
        public async Task<IActionResult> GetById(Guid id)
        {
            try
            {
                var ferramenta = await _ferramentaService.BuscarPorID(id);
