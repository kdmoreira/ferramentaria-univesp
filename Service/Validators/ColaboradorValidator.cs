    ...
    public class ColaboradorValidator : AbstractValidator<Colaborador>
    {
        public ColaboradorValidator()
        {
            ...
            RuleFor(x => x.Matricula)
                ...
                .MaximumLength(20).WithMessage("O campo matrícula deve ter no máximo 20 caracteres.");
            ...
            RuleFor(x => x.Sobrenome)
                ...
                .MaximumLength(255).WithMessage("O campo sobrenome deve ter no máximo 255 caracteres.");
            ...
            RuleFor(x => x.Cargo)
                ...
                .MaximumLength(100).WithMessage("O campo cargo deve ter no máximo 100 caracteres.");

            RuleFor(x => x.Empresa)
                .NotEmpty().WithMessage("Empresa é obrigatória.")
                .MaximumLength(100).WithMessage("O campo empresa deve ter no máximo 100 caracteres.");
